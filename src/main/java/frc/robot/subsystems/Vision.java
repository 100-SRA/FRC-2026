 ...
 *   1. Open the PhotonVision dashboard (http://photonvision.local:5800) and
 *      confirm the camera name — replace CAMERA_NAME below with the exact name shown.
 *   2. Set up a pipeline for your target (AprilTag or retroreflective tape).
 *   3. Measure and fill in the physical constants below (camera height, angle, target height).
 *
 * To enable: uncomment all lines marked with // and remove this block comment.
 */
// public class Vision extends SubsystemBase {
//
//   // -------------------------------------------------------------------------
//   // Physical constants — measure these on the actual robot
//   // -------------------------------------------------------------------------
//
//   /** Name of the camera in PhotonVision dashboard (case-sensitive). */
//   private static final String CAMERA_NAME = "YOUR_CAMERA_NAME";
//
//   /** Height of the camera lens above the floor, in meters. */
//   private static final double CAMERA_HEIGHT_METERS = 0.5;
//
//   /** Camera mounting angle above horizontal, in degrees (positive = tilted up). */
//   private static final double CAMERA_PITCH_DEGREES = 30.0;
//
//   /** Height of the center of the target above the floor, in meters. */
//   private static final double TARGET_HEIGHT_METERS = 2.5;
//
//   // -------------------------------------------------------------------------
//   // Shooter speed tuning — adjust these based on field testing
//   // -------------------------------------------------------------------------
//
...
//    *
//    * Formula: distance = (targetHeight - cameraHeight) / tan(cameraPitch + targetPitch)
//    */
